...
frappe.ui.form.on("Delivery Note", {
	...
	setup: function(frm) {
		...
		if(frappe.user_roles.indexOf("Delivery Note Without Value") > -1){
			var df = frappe.meta.get_docfield("Delivery Note Item", "rate",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "base_rate",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "price_list_rate",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "base_price_list_rate",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "amount",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "base_amount",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "net_rate",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "base_net_rate",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "net_amount",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "base_net_amount",frm.doc.name);
			df.hidden = 1;
			var df = frappe.meta.get_docfield("Delivery Note Item", "incoming_rate",frm.doc.name);
			df.hidden = 1;
