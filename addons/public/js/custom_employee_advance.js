...
frappe.ui.form.on('Employee Advance', {
	...
	refresh: function(frm) {
		...
		cur_frm.remove_custom_button("Return","Create")
		cur_frm.remove_custom_button("Expense Claim","Create")
		cur_frm.remove_custom_button("Deduction from salary","Create")
	...
	make_expense_claim: function(frm) {
		return frappe.call({
			method: "addons.custom_standard.custom_employee_advance.custom_get_expense_claim",
			args: {
