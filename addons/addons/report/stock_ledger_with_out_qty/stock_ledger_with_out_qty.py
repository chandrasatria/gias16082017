...
def get_columns():
	...
	columns = [
		...
		{"label": _("Out Value"), "fieldname": "out_value", "fieldtype": "Currency", "width": 110, "options": "Company:company:default_currency"},
...
def get_stock_ledger_entries(filters, items):
	...
	sl_entries = frappe.db.sql("""
		SELECT
			...
			IF(actual_qty < 0, actual_qty * valuation_rate, 0) as out_value
		FROM
