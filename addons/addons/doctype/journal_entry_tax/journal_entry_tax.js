...
frappe.ui.form.on("Journal Entry Tax", {
	setup: function(frm) {
...
var update_jv_details = function(doc, r) {
	$.each(r, function(i, d) {
		var row = frappe.model.add_child(doc, "Journal Entry Account Tax", "accounts");
...
frappe.ui.form.on("Journal Entry Account Tax", {
...
frappe.ui.form.on("Journal Entry Account Tax", "accounts_remove", function(frm) {
	cur_frm.cscript.update_totals(frm.doc);
});
